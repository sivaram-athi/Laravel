        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                if($search == $_SESSION['words']){
                    header("location:include/$search");
                }
            }
        }
...
<body style="background:url(./include/assets/img/mountains.jpg); background-repeat:no-repeat; background-size:cover;">
    ...
    <div class="container">
        <div class="shadow-lg rounded hell" style="background:#00000030;">
